      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-ink-400 border-t pt-6">
          <div className="flex items-center gap-2">
            ...
            <a href="https://github.com/madankumargs/vsixgate" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 rounded-full bg-white border px-3 py-1 font-semibold text-ink-700 hover:bg-slate-50">
              ...
              github.com/madankumargs/vsixgate
            </a>
          </div>
